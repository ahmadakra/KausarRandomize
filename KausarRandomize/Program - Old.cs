...
namespace KausarRandomize.V1
{
    class Program
    {
        static void MainOld(string[] _)
        {
            ...
            do
            {
                ...
                // First item
                var seq = new Sequence { Emotion = Emotion.Positive, Item = 2 };
                trial.Add(seq);
                ...
                for (int i = 1; i < 20; i++)
                {
                    ...
                    // Next item
                    seq = new Sequence { Emotion = nextEmotion, Item = nextItem };
                    trial.Add(seq);
                }
        ...
        private static bool TrialLooksGood(List<Sequence> list)
        {
            ...
            var n1 = list.Count(e => e.Emotion == Emotion.Negative && e.Item == 1);
            if (n1 != 5)
            {
            ...
            var n2 = list.Count(e => e.Emotion == Emotion.Negative && e.Item == 2);
            if (n2 != 5)
            {
            ...
            var p1 = list.Count(e => e.Emotion == Emotion.Positive && e.Item == 1);
            if (p1 != 5)
            {
            ...
            var p2 = list.Count(e => e.Emotion == Emotion.Positive && e.Item == 2);
            if (p2 != 5)
            {
    ...
    struct Sequence
    {
        ...
        {
            string objString = Item == 1 ? "1st" : "2nd";
